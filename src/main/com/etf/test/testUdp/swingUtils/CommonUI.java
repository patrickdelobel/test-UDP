package com.etf.test.testUdp.swingUtils;
...
public class CommonUI {
    ...
    public static JLabel createLabel(String text) {
        return createLabel(text, -1, (Component)null);
    }
    ...
    public static JTextField createTextField(String text, boolean numbers) {
        return createTextField(text, (KeyListener)null, numbers);
    }
    ...
    public static JTextField createTextField(String text) {
        return createTextField(text, (KeyListener)null, false);
    }
    ...
    public static JRadioButton createRadioButton(String text, int mnemonic, boolean selected) {
        return createRadioButton(text, mnemonic, (ActionListener)null, selected);
    }
    ...
    public static JRadioButton createRadioButton(String text, int mnemonic) {
        return createRadioButton(text, mnemonic, (ActionListener)null, false);
    }

    public static JRadioButton createRadioButton(String text) {
        return createRadioButton(text, -1, (ActionListener)null, false);
    }
    ...
    public static JCheckBox createCheckBox(String text, int mnemonic, boolean selected) {
        return createCheckBox(text, mnemonic, (ActionListener)null, selected);
    }

    public static JCheckBox createCheckBox(String text, int mnemonic) {
        return createCheckBox(text, mnemonic, (ActionListener)null, false);
    }

    public static JCheckBox createCheckBox(String text) {
        return createCheckBox(text, -1, (ActionListener)null, false);
    }
    ...
    public static JComboBox createComboBox(Object[] items, boolean editable) {
        return createComboBox((Object[])items, (ActionListener)null, editable);
    }
    ...
    public static JComboBox createComboBox(Vector items, boolean editable) {
        return createComboBox((Vector)items, (ActionListener)null, editable);
    }
    ...
    public static void centerComponent(Component source) {
        centerComponent(source, (Component)null);
    }
    ...
    public static JFrame getParentFrame(Component source) {
        ...
        return parent == null?null:(JFrame)parent;
    }
    ...
    public static String[] stringArrayFromString(String string, String delim) {
        ...
        for(int var5 = 0; st.hasMoreTokens(); strings[var5++] = st.nextToken()) {
            ;
        }
